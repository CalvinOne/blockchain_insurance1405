...
//set web words info
  ...
  setBlock: function(message) {
    var Block = document.getElementById("block");
    Block.innerHTML = message;
  },
  //get info from Ethereum
  getMessage: function(){
    ...
    saveMessage: function(){
        ...
        Credit.deployed().then(function(instance) {
            meta = instance;
            return meta.create(identity, name, category, price, {from: account});
        }).then(function(){
    ...
    getBlock: function(){
        ...
        Credit.deployed().then(function(instance) {
            meta = instance;
            return meta.setCurrentBlockNum.call({from: account});
        }).then(function(value){
            self.setBlock(value);
        }).catch(function(e) {
          console.log(e);
          self.Block("Error getting message. see log.");
        });
      },
